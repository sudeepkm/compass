...
public class CompassPageFactory {
  ...
  public static void initElements(final WebDriver driver, final Object page) {
    final
    Map<String, List<WebElement>>
        locatedFields = initElements(new CustomElementLocatorFactory(driver), page);
  ...
  public static Map<String, List<WebElement>> initElements(
      final CustomElementLocatorFactory factory, final Object page) {
    return initElements(new CustomFieldDecorator(factory), page);
  }

  public static Map<String, List<WebElement>> initElements(final CustomFieldDecorator decorator,
                                                           final Object page) {
  ...
  private static Map<String, List<WebElement>> mergeValues(
      final Map<String, List<WebElement>> foundInSubclasses,
  ...
  private static Map<String, List<WebElement>> proxyFields(final FieldDecorator decorator,
                                                           final Object page,
                                                           final Class<?> proxyIn) {
      ...
      if (value != null) {
        try {
          ...
          if (locatedFields.containsKey(field.getName())) {
            ...
            if (!(value instanceof List)) {
              locatedFields.put(field.getName(), new ArrayList<WebElement>(
                  Arrays.asList((WebElement) value)));
            }
          }
